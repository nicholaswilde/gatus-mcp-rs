...
## Phase 4: Verification [checkpoint: 770c87e]
- [x] Add integration tests in `tests/` for each new tool. 5649c96
- [x] Verify token efficiency of new payloads. 5649c96
- [x] Update documentation. 5649c96
