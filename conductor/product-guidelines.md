...
- **Tool Grouping:** Group related actions (e.g., 'list' and 'status') into a single tool with an `action` argument to reduce the number of tool definitions and optimize token usage during discovery.
