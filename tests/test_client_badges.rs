...
fn test_get_badge_url() {
    ...
    assert_eq!(
        url,
        "https://status.example.org/api/v1/endpoints/core_ext-ep-test/health/badge.svg"
    );
}
...
fn test_get_uptime_badge_url() {
    ...
    assert_eq!(
        url,
        "https://status.example.org/api/v1/endpoints/core_ext-ep-test/uptimes/24h/badge.svg"
    );
}
