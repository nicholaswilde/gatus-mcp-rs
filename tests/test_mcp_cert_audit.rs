...
#[tokio::test]
async fn test_mcp_handle_certificate_audit() {
    ...
    assert!(text.contains("Certificate Audit: service-1 (core)"));
    assert!(text.contains("Let's Encrypt"));
    assert!(text.contains("RSA-2048"));
